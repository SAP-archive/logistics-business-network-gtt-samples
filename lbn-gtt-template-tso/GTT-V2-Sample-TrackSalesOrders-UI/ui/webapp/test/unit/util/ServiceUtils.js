sap.ui.define(["com/sap/gtt/app/sample/sof/util/ServiceUtils"], function (ServiceUtils) {
  "use strict";
  ...
  QUnit.test("getUrl", function (assert) {
    ...
    var component = {};
    var manifestObject = {};
    stub(manifestObject, "getComponentName").returns("com.sap.gtt.app.sample.sof");
