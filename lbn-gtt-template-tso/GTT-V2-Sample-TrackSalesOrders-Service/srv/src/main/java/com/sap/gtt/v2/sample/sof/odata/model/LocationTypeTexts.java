...
@EdmEntitySet(name = LocationTypeTexts.ENTITY_SET_NAME, container = Constants.ENTITY_CONTAINER_NAME)
public class LocationTypeTexts {
    public static final String ENTITY_SET_NAME = "LocationType_texts";
