CLASS zcl_gtt_pof_tp_factory_poi DEFINITION
  PUBLIC
...
CLASS zcl_gtt_pof_tp_factory_poi IMPLEMENTATION.


  METHOD zif_gtt_pof_tp_factory~get_bo_reader.

    ro_bo_reader    = NEW zcl_gtt_pof_tp_reader_poi(
  ...
  METHOD zif_gtt_pof_tp_factory~get_pe_filler.
    ...
    ro_pe_filler    = NEW zcl_gtt_pof_pe_filler_poi(
                        io_ef_parameters = io_ef_parameters
