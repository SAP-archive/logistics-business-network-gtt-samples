FUNCTION ZGTT_SOF_EE_SHP_LOAD_START_REL .
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
* <5> Check actual event date and time changed.
  ...
  IF <ls_xvttk>-updkz EQ gc_insert.
    IF <ls_xvttk>-dalbg IS NOT INITIAL
    OR <ls_xvttk>-ualbg IS NOT INITIAL.
   ...
   ELSE.
     ...
     IF sy-subrc IS INITIAL.
       IF <ls_xvttk>-dalbg <> <ls_yvttk>-dalbg
       OR <ls_xvttk>-ualbg <> <ls_yvttk>-ualbg.
         lv_aot_relevance = gc_true.
       ENDIF.
     ENDIF.
  ENDIF.
