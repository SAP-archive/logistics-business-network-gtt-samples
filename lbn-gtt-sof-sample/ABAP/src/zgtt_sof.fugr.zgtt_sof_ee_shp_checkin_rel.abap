FUNCTION ZGTT_SOF_EE_SHP_CHECKIN_REL .
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
* <5> Check actual event date and time changed.
  ...
  IF <ls_xvttk>-updkz EQ gc_insert.
    IF <ls_xvttk>-dareg IS NOT INITIAL
    OR <ls_xvttk>-uareg IS NOT INITIAL.
   ...
   ELSE.
     ...
     IF sy-subrc IS INITIAL.
       IF <ls_xvttk>-dareg <> <ls_yvttk>-dareg
       OR <ls_xvttk>-uareg <> <ls_yvttk>-uareg.
         lv_aot_relevance = gc_true.
       ENDIF.
     ENDIF.
  ENDIF.
