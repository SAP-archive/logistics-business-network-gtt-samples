...
public class Route implements Serializable {
    private List<PlannedSpot> plannedSpots = new ArrayList<>();
    private CurrentLocation currentLocation;
    private PlannedEvent nextStopEvent;
    private String groupId;
    private List<ActualSpot> actualSpots = new ArrayList<>();
    private String altKey;
    private String transportationModeCode;
    private UUID firstPlannedEventId;
    private String executionStatusCode;
    @JsonProperty("stops")
    private List<StopsForVP> stopsForVPS = new ArrayList<>();
    private Set<String> locationAltKey = new HashSet<>();
    private String destinationLocationAltKey;
    private LocationDTO destinationLocation;
    private ValidCoordinates actualSpotsValidation = new ValidCoordinates();
    private ValidCoordinates plannedLocationsValidation = new ValidCoordinates();
