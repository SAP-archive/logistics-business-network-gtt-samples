package com.sap.gtt.v2.sample.sst.odata;

import com.sap.gtt.v2.sample.sst.common.exception.SSTServiceException;
import com.sap.gtt.v2.sample.sst.odata.callback.ExpandEntityCallback;
import com.sap.gtt.v2.sample.sst.odata.callback.ExpandEntitySetCallback;
import com.sap.gtt.v2.sample.sst.odata.handler.ODataHandlerFactory;
import com.sap.gtt.v2.sample.sst.odata.handler.SSTODataHandler;
...
/**
 * {@link SSTODataSingleProcessor} is an OData processor which is wraps every HTTP OData request.
 *
 * @author Min Li
 */
@Service
@Scope("prototype")
public class SSTODataSingleProcessor extends ODataSingleProcessor {
    ...
    public ODataResponse readEntitySet(GetEntitySetUriInfo uriInfo, String contentType) throws ODataException {
        SSTODataHandler handler = oDataHandlerFactory.getHandler(uriInfo.getTargetType());
