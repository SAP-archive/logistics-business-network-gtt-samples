...
@EdmEntitySet(name = ShippingType.ENTITY_SET_NAME, container = ENTITY_CONTAINER_NAME)
public class ShippingType {
    ...
    @EdmNavigationProperty(name = "localized", toType = ShippingTypeText.class, toMultiplicity = ONE)
    private ShippingTypeText localized;

    public ShippingTypeText getLocalized() {
        return localized;
    }

    public void setLocalized(ShippingTypeText localized) {
