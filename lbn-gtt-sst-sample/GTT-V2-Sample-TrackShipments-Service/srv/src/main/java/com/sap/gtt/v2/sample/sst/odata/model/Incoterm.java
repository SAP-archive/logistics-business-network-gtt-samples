...
@EdmEntitySet(name = Incoterm.ENTITY_SET_NAME, container = ENTITY_CONTAINER_NAME)
public class Incoterm {

    public static final String ENTITY_SET_NAME = "Incoterm";
    ...
    @EdmNavigationProperty(name = "localized", toType = IncotermText.class, toMultiplicity = ONE)
    private IncotermText localized;
    ...
    public IncotermText getLocalized() {
        return localized;
    }

    public void setLocalized(IncotermText localized) {
