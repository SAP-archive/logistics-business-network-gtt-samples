...
@EdmEntitySet(name = ProcessStatus.ENTITY_SET_NAME, container = ENTITY_CONTAINER_NAME)
public class ProcessStatus {
    ...
    @EdmNavigationProperty(name = "localized", toType = ProcessStatusText.class, toMultiplicity = ONE)
    private ProcessStatusText localized;

    public ProcessStatusText getLocalized() {
        return localized;
    }

    public void setLocalized(ProcessStatusText localized) {
