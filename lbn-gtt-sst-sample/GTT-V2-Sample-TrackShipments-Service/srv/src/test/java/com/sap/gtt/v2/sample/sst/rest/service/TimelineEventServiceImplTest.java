...
class TimelineEventServiceImplTest {
    ...
    @InjectMocks
    private TimelineEventServiceImpl timelineEventService;
    ...
    void getByShipmentId_givenShipmentId_shouldReturnTimelineEvents() {
        ...
        when(plannedEventService.getAllByShipmentId(shipmentId)).thenReturn(singletonList(plannedEvent));
        ...
        // when
        final List<TimelineEvent> timelineEvents = timelineEventService.getByShipmentId(shipmentId);
