...
@EdmEntitySet(name = EventStatusTexts.ENTITY_SET_NAME, container = Constants.ENTITY_CONTAINER_NAME)
public class EventStatusTexts {
    public static final String ENTITY_SET_NAME = "EventStatus_texts";
    @EdmKey
