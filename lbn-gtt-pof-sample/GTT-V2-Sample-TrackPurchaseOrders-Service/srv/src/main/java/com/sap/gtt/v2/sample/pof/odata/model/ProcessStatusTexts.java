...
@EdmEntitySet(name = ProcessStatusTexts.ENTITY_SET_NAME, container = Constants.ENTITY_CONTAINER_NAME)
public class ProcessStatusTexts {
    public static final String ENTITY_SET_NAME = "ProcessStatus_texts";
    @EdmKey
