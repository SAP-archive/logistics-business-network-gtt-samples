...
@EdmEntitySet(name = ShippingTypeTexts.ENTITY_SET_NAME, container = Constants.ENTITY_CONTAINER_NAME)
public class ShippingTypeTexts {
    public static final String ENTITY_SET_NAME = "ShippingType_texts";
