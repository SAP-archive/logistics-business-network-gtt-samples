sap.ui.define(
  ...
  function (MockServer, JSONModel, Log, UriParameters) {
    ...
    var oMockServer;
    var _sAppModulePath = "com/sap/gtt/app/sample/pof/";
      ...
      init: function (oOptionsParameter) {
        ...
        return new Promise(function (fnResolve, fnReject) {
          ...
          oManifestModel.attachRequestCompleted(function () {
            ...
            var sMockServerUrl = sap.ui.require.toUrl(_sAppModulePath + oMainDataSource.uri); // "/pof/odata/v1/"
            ...
            var jsonMockServer = new MockServer({
              ...
              requests: [
                ...
                {
                  method: "GET",
                  path: /\/documentItemFlow(.*)/,
                  response: function (oXhr) {
                    var mockdataFileUrl = sap.ui.require.toUrl(
                      _sAppModulePath + oJsonDataSource.settings.localUri + "documentItemFlow.json"
                    );
                    oXhr.respondFile(200, {}, mockdataFileUrl);
                    return true;
                  },
                },
                {
                  ...
                  response: function (oXhr) {
                    var mockdataFileUrl = sap.ui.require.toUrl(
                      _sAppModulePath + oJsonDataSource.settings.localUri + "timelineEvent.json"
                    );
                    oXhr.respondFile(200, {}, mockdataFileUrl);
                    return true;
                  },
                },
                {
                  ...
                  response: function (oXhr) {
                    var mockdataFileUrl = sap.ui.require.toUrl(
                      _sAppModulePath + oJsonDataSource.settings.localUri + "hereMapKey.json"
                    );
                    oXhr.respondFile(200, {}, mockdataFileUrl);
                    return true;
                  },
