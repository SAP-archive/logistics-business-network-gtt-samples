...
@EdmEntitySet(name = CarrierReferenceDocumentType.ENTITY_SET_NAME, container = ENTITY_CONTAINER_NAME)
public class CarrierReferenceDocumentType {
    ...
    @EdmNavigationProperty(name = "localized", toType = CarrierReferenceDocumentTypeText.class, toMultiplicity = ONE)
    private CarrierReferenceDocumentTypeText localized;

    public CarrierReferenceDocumentTypeText getLocalized() {
        return localized;
    }

    public void setLocalized(CarrierReferenceDocumentTypeText localized) {
