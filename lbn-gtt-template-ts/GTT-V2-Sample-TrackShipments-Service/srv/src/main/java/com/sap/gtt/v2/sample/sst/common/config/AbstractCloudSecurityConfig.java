...
/**
 * {@link AbstractCloudSecurityConfig} is an abstract security config for cloud environment.
 *
 * @author Min Li
 */
public abstract class AbstractCloudSecurityConfig extends WebSecurityConfigurerAdapter {
