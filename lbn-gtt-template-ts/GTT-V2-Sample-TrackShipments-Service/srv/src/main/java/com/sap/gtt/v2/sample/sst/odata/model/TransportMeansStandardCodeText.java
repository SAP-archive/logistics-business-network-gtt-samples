...
@EdmEntitySet(name = TransportMeansStandardCodeText.ENTITY_SET_NAME, container = ENTITY_CONTAINER_NAME)
public class TransportMeansStandardCodeText {

    public static final String ENTITY_SET_NAME = "TransportMeansStandardCode_texts";
