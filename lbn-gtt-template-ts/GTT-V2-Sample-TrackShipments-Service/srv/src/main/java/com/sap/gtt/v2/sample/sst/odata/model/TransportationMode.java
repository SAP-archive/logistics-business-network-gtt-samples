...
@EdmEntitySet(name = TransportationMode.ENTITY_SET_NAME, container = ENTITY_CONTAINER_NAME)
public class TransportationMode {
    ...
    @EdmNavigationProperty(name = "localized", toType = TransportationModeText.class, toMultiplicity = ONE)
    private TransportationModeText localized;

    public TransportationModeText getLocalized() {
        return localized;
    }

    public void setLocalized(TransportationModeText localized) {
