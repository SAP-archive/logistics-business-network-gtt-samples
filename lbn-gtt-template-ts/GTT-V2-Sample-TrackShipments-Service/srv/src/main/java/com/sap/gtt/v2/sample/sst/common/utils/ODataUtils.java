...
import static com.sap.gtt.v2.sample.sst.common.exception.SSTServiceException.MESSAGE_CODE_INVALID_JSON;
...
/**
 * {@link ODataUtils} is an util class for OData requests.
 *
 * @author Min Li
 */
public class ODataUtils {
    ...
    public static <T> T readEntity(String json, Class<T> classOfT) {
        return readEntity(new Gson().fromJson(json, JsonObject.class), classOfT);
    }
    ...
    private static <T> T readEntityEdm(JsonObject jsonObject, Class<T> classOfT) {
        ...
        try {
            ...
            throw new SSTServiceException(MESSAGE_CODE_INVALID_JSON);
        }
        return t;
    }
