...
@EdmEntitySet(name = EventStatus.ENTITY_SET_NAME, container = ENTITY_CONTAINER_NAME)
public class EventStatus {
    ...
    @EdmNavigationProperty(name = "localized", toType = EventStatusText.class, toMultiplicity = ONE)
    private EventStatusText localized;
    ...
    public EventStatusText getLocalized() {
        return localized;
    }

    public void setLocalized(EventStatusText localized) {
